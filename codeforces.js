/**
 * @OnlyCurrentDoc
 * Sistema de Análise de Performance do Codeforces v4.8 ESTÁVEL
 * Lógica de descoberta de contests reescrita para ser mais simples e robusta,
 * separando a busca de 'Rated' e 'Virtual' e garantindo o processamento completo.
 */
...
function onOpen() {
  SpreadsheetApp.getUi()
    ...
    .addItem('🗄️ Criar/Zerar Abas de Banco de Dados', 'criarAbasDeBancoDeDados')
    .addToUi();
}
...
// ===================================================================================
// LÓGICA DE ATUALIZAÇÃO DO BANCO DE DADOS (VERSÃO SIMPLIFICADA)
// ===================================================================================
...
function calcularUpsolving(handle, contestId, contestEndTime) {
  let upsolvedCount = 0;
  // A busca de upsolving precisa ser mais ampla. Vamos buscar as últimas 500 submissões gerais.
